...
class MyCitiesTableViewController: UITableViewController {
    ...
    @IBAction func unwindSegue(_ segue: UIStoryboardSegue) {
        ...
        case 0:
           city = tableViewController.europCities[indexPath.row]
        case 1:
            city = tableViewController.asiaCities[indexPath.row]
        default: break
        }
//       let city = tableViewController.cities[indexPath.row]
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        guard let cell = tableView.dequeueReusableCell(withIdentifier: "Cell", for: indexPath) as? MyCitiesTableViewCell else { return UITableViewCell()}
